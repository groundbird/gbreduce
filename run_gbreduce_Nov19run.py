...
#rsync -avz -e "ssh -A mpeel@moa.gb.iac.es ssh"  mpeel@dodo.gb.iac.es:/data/gb/ /Volumes/iOmega/GroundBIRD/data
...
toreduce.append(['20191112/data_084823',datetime(2019,11,12,8,48,45).timestamp()])
toreduce.append(['20191112/data_094847',datetime(2019,11,12,9,49,9).timestamp()])
toreduce.append(['20191112/data_104911',datetime(2019,11,12,10,49,33).timestamp()])
toreduce.append(['20191112/data_114935',datetime(2019,11,12,11,49,56).timestamp()])
